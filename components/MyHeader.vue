...
<template>
    <div>
        <div class=" border-b border-slate-300 mb-4 py-5 flex flex-col gap-8">
            <div class=" flex justify-between md:flex md:justify-between">
                <NuxtLink to="/"
            ...
            <div class=" flex flex-col gap-4 md:flex md:flex-row md:gap-40 md:items-center">
                <div @click="toggleCategories"
                    class=" flex flex-row w-32 md:gap-14 relative border border-slate-300 p-2 rounded-full items-center cursor-pointer">
